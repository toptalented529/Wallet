 ...
 *  contacts they have saved in Scallop and any addresses they have recently
 *  sent to.
 * @property {Account} selectedAccount - The currently selected account in
 *  Scallop. Native balance and address will be pulled from this account if a
...
export const initializeSendState = createAsyncThunk(
  ...
  async ({ chainHasChanged = false } = {}, thunkApi) => {
     ...
     * @property {Object} metamask - Half baked type for the Scallop object
