...
export default class Tabs extends Component {
  ...
  renderTabs() {
    ...
    return React.Children.map(this._getValidChildren(), (child, index) => {
      ...
      // const exportTabName = this.state.activeTabIndex;
  ...
  render() {
    ...
    return (
      <div className="tabs">
        <div style={{flex:1,overflow:"auto"}} className="tabs__content">{this.renderActiveTabContent()}</div>
        <ul 
        style={{  boxShadow: "0px -1px 10px rgba(0, 0, 0, 0.05)"}}
